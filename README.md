...
| --> Implementación usando frameworks||
|||
|5. MLP a medida|Lunes 29 de marzo|
| --> Capas y Bloques||
...
| --> GPU||
|||
|6. Algoritmos de Optimización|Miércoles 31 de marzo|
...
| --> ADAM||
|||
|7. Selección de modelos|Lunes 5 de abril|
| --> Underfittng||
| --> Overfitting||
| --> Regularización de los pesos||
| --> Dropout||
|||
|8. Redes convolucionales (CNN)|Miércoles 7 de abril|
...
|||
|9. Arquitecturas CNN Modernas|Lunes 12 de abril|
| --> AlexNet e ImageNet||
| --> Bloques VGG||
| --> Bloques NiN||
...
| --> Implementación usando frameworks||
|||
|14. Arquitecturas RNN Modernas|Miércoles 28 de abril|
| --> Recurrencias con compuertas: GRU||
| --> Recurrencia con memoria: LSTM||
| --> Recurrencia bidireccional||
|||
|15. Analisis de sentimiento|Lunes 3 de mayo|
| --> Implementación con RNN||
| --> Implementación con CNN||
|||
|16. Traducción automática|Miércoles 5 de mayo|
